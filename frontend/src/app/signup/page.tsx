  ...
  return (
    <div className="max-w-md mx-auto py-10">
      <div className="rounded-2xl bg-surface border border-border p-6 shadow-card space-y-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-text-primary">Create your pilot profile</h1>
          <p className="text-sm text-text-muted mt-1">Your XP, badges, follows, and leaderboard identity start here.</p>
        </div>
